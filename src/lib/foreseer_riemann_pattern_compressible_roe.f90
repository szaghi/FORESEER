...
contains
   ...
   associate(r_1=>self%r_1, r_4=>self%r_4, u_1=>self%u_1, u_4=>self%u_4, p_1=>self%p_1, p_4=>self%p_4,              &
             ...
             H_1=>self%eos_1%total_entalpy(density=self%r_1, pressure=self%p_1, velocty_sq_norm=self%u_1*self%u_1), &
             H_4=>self%eos_4%total_entalpy(density=self%r_4, pressure=self%p_4, velocty_sq_norm=self%u_4*self%u_4), &
             cp_1=>self%eos_1%cp(), cp_4=>self%eos_4%cp())
