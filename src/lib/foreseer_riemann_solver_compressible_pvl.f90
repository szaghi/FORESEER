...
contains
   ...
   class(riemann_solver_compressible_pvl), intent(in)           :: self    !< Solver object.
   ...
   desc = ''
   desc=desc//prefix_//'PVL solver'
   endfunction description

   elemental subroutine destroy(self)
   !< Destroy solver.
   class(riemann_solver_compressible_pvl), intent(inout) :: self  !< Solver.
   type(riemann_solver_compressible_pvl)                 :: fresh !< Fresh solver instance.
