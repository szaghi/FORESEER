...
contains
   ...
   type(riemann_pattern_compressible)        :: pattern      !< Riemann pattern.
   ...
   call pattern%compute(eos_left=eos_left, state_left=state_left_, eos_right=eos_right, state_right=state_right_, &
                        normal=normal)
