!< FORESEER test: Riemann solver compressible exact (Newton iterative) class test.

program foreseer_test_riemann_solver_compressible_hllc
!< FORESEER test: Riemann solver compressible exact (Newton iterative) class test.

use foreseer, only : eos_compressible, conservative_compressible, riemann_solver_compressible_exact
